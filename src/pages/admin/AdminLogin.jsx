      ...
      <div className='flex justify-center text-center textFont text-[#12172B] my-8'>
        <div className='py-14 px-8 bg-white rounded-xl border-2 border-[#12172B]'>
          <div className='flex items-center justify-center'>
            ...
            <input type="text" className="border-b-2 border-[#12172b] ml-2 p-1 focus:outline-none" name='studentId' value={studentInfo.studentId} onChange={handleInputChange}/> 
          </div>
          <div className='flex items-center justify-center mt-4'>
            <p className='pt-2'>이름 :</p>
            <input type="text" className="border-b-2 border-[#12172b] ml-2 p-1 focus:outline-none" name='name' value={studentInfo.name} onChange={handleInputChange}/> 
          </div>
