...
const AgreeModal = () => {
    return (
        <div className='flex justify-center items-center textFont border-2 border-[#AB7A67] rounded-2xl py-10 mx-4'>
            <div className='text-center p-4'>
                <div className=''>
                    <p className='text-2xl text-[#AB7A67] mb-3'>Puzzle 웹사이트 사용을 위한<br/>개인정보 수집 이용 및 제공 동의서</p>
                ...
                <div>
                    <input type='button' value='동의' className='bg-[#AB7A67] text-white rounded-2xl p-1 px-9 mr-2'/>
                    <input type='button' value='취소' className='text-[#AB7A67] border-2 border-[#AB7A67] rounded-2xl p-1 px-9 ml-2'/>
                </div>
            </div>
        </div>
    );
