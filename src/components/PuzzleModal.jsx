...
function PuzzleModal({setModalOpen}) {
    const closeModal =()=>{
        setModalOpen(false);
    };
  return (
    <div className='absolute z-50 top-0'>
        <div className='flex justify-center items-center border-4 border-[#476832] rounded-2xl h-100% w-full p-5 text-center bg-[#FCFFE3]'>
            <div>
                ...
                <div className='p-5'>
                    <div className='box w-2/3 h-2/3 bg-[url{images.menuPuzzle}]'></div>
                    <img src={images.menuPuzzle} className='mb-5 w-2/3 mx-auto'/>
                    <p className='text-xl'>동아리 박람회</p>
                    <p>3월 28일 목</p>
                </div>
            </div>
        </div>
