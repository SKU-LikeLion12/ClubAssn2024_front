...
function FailModal({setFailModalOpen}) {
    const closeModal =()=>{
  ...
  return (
    <div className='fixed inset-0 z-50 flex justify-center items-center bg-black bg-opacity-20'>
        <div className=''>
            <div className='flex justify-center items-center textFont border-2 border-[#AB7A67] rounded-xl mx-16 bg-white'>
                <div className='p-5'>
